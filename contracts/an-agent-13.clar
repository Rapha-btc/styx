...
(define-constant DEPLOYED_STACKS_BLOCK burn-block-height) ;; stacks-block-height)
...
(define-constant ACCOUNT_OWNER 'ST2JHG361ZXG51QTKY2NQCVBPPRRE2KZB1HR05NNC) ;; address1 
(define-constant ACCOUNT_AGENT 'ST2NEB84ASENDXKYGJPQW86YXQCEFEX2ZQPG87ND) ;; address2

;; (define-constant SBTC_TOKEN 'SM3VDXK3WZZSA84XXFKAFAF15NNZX32CTSG82JFQ4'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.sbtc-token) ;; sBTC token
...
(begin
  ...
  (try! (contract-call? 'ST29D6YMDNAKN1P045T6Z817RTE1AC0JAAAG2EQZZ.agent-account-registry auto-register-agent-account ACCOUNT_OWNER ACCOUNT_AGENT))
  (ok true)
)
