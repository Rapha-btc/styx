...
```clarity
(contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.register-ai-account is-operator tx-sender)
(contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.register-ai-account is-operator 'SP6SA6BTPNN5WDAWQ7GWJF1T5E2KWY01K9SZDBJQ)
```

### **2. Propose AI Account Registration**
```clarity
;; Test proposal (replace with real AI account contract)
(contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.register-ai-account 
  propose-ai-account-registration 
  'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.test-ai-account
...
(contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.register-ai-account get-registration-proposal u1)

;; Check if user already registered
(contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.register-ai-account is-user-registered 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE)
```
...
(contract-call? 'ST1PQHQKV0RJXZFY1DGX8MNSNYVE3VGZJSRTPGZGM.register-ai-account signal-registration-approval u1)
```
