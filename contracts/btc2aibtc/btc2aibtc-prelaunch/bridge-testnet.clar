...
;; another example of requirements not working
;; (use-trait faktory-pre 'ST29D6YMDNAKN1P045T6Z817RTE1AC0JAAAG2EQZZ.prelaunch-faktory-trait.prelaunch-trait) ;; updated
(use-trait faktory-pre 'ST29D6YMDNAKN1P045T6Z817RTE1AC0JAAAG2EQZZ.prelaunch-faktory-trait.prelaunch-trait)
...
(define-constant SERVICE_STYX 'ST1G655MB1JVQ5FBE2JJ3E01HEA6KBM4H394VWAD6) ;; amend it for mainnet Rafa
(define-constant SBTC_CONTRACT 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.sbtc-token)
...
(define-public (swap-btc-to-aibtc
  ...
  (let (
      ...
      (ai-account (unwrap! (contract-call? 'ST29D6YMDNAKN1P045T6Z817RTE1AC0JAAAG2EQZZ.agent-account-registry get-agent-account-by-owner tx-sender) ERR-NO-AI-ACCOUNT))) ;; 'ST29D6YMDNAKN1P045T6Z817RTE1AC0JAAAG2EQZZ.
    ...
    (if bonded
        (let ((ai-pool-allowed (get pool-contract dex-info)))
                    ...
                    (match (as-contract (contract-call? 'STTWD9SPRQVD3P733V89SV0P8RZRZNQADG034F0A.xyk-core-v-1-2 swap-x-for-y
