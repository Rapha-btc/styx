...
(define-constant ERR_ALREADY_DONE (err u107))
(define-constant ERR_NO_STX_RECEIVER (err u108))
(define-constant ERR_BTC_TX_ALREADY_USED (err u109)) 
(define-constant ERR_IN_COOLDOWN (err u110))
(define-constant ERR_INVALID_STX_SENDER (err u112))
(define-constant ERR_INVALID_ID (err u113))
(define-constant ERR_FORBIDDEN (err u114))
(define-constant ERR_AMOUNT_NULL (err u115))
(define-constant ERR_NO_BTC_RECEIVER (err u116)) 
