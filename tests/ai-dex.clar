...
;; ab6a0ab8032718318f1284c86a0320d0df0f8d50c77fc62c8c780c24a90c235a
      ;; aibtc.dev DAO faktory.fun DEX @version 1.0
    
      (impl-trait 'ST1Q9YZ2NY4KVBB08E005HAK3FSM8S3RX2WARP9Q1.aibtc-dao-traits.faktory-dex)
      (impl-trait 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.faktory-dex-trait-v21.dex-trait)
      ...
      (define-constant DEX-TOKEN 'ST2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5EWQWKRW.lemar1-faktory)
      ...
      (define-public (buy (ft <faktory-token>) (ubtc uint))
        (begin
          ...
          (try! (contract-call? 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.sbtc-token 
                      transfer pre-fee tx-sender 'ST2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5EWQWKRW.lemar1-pre-faktory none))
          (try! (as-contract (contract-call? 'ST2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5EWQWKRW.lemar1-pre-faktory create-fees-receipt pre-fee)))        
          (try! (contract-call? 'STV9K21TBFAK4KNRJXF5DFP8N7W46G4V9RJ5XDY2.sbtc-token 
            ...
            (if (>= new-stx TARGET_STX)
                ...
                (try! (as-contract (contract-call? ft transfer originator-amount tx-sender ORIGINATOR none)))
                  ...
                  (try! (as-contract (contract-call? 'ST2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5EWQWKRW.lemar1-pre-faktory toggle-bonded)))
      ...
      (define-public (open-market) 
        (let ((is-prelaunch-allowing (unwrap-panic (contract-call? 'ST2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5EWQWKRW.lemar1-pre-faktory is-market-open))))
        ...
        (begin
          ...
          (var-set ft-balance u16000000000000000)
            (print { 
                ...
                poolName: 'ST2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5EWQWKRW.xyk-pool-sbtc-lemar1-v-1-1
           })
          (ok true))