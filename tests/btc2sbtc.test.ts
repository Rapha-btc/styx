  ...
  describe("Debug Agent Lookup", () => {
    ...
    it("DEBUG: Check agent account lookup for first owner", () => {
      ...
      try {
        ...
        console.log("- cvToValue error:", error);
      }
      ...
      try {
        ...
        console.log("Swap failed with error:", error);
      }
  ...
  describe("Simple Market Open Test", () => {
    it("Test is-market-open with no setup", () => {
      ...
      try {
        ...
        console.log("Error calling is-market-open:", error);
        console.log(
      ...
      try {
        ...
        console.log("Error calling get-contract-status:", error);
      }
      ...
      try {
        ...
        console.log("Error calling get-seats-owned:", error);
      }
    ...
    it("Prelaunch Completion + Dex Buy Test", { timeout: 20000 }, () => {
      ...
      try {
        ...
        if (secondDexSwapResult.result.type === ClarityType.ResponseOk) {
          console.log(
            `✓ Second DEX buy succeeded! Should reach ~5M sats target`
          );
