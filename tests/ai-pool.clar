...
;; Implement XYK pool trait and use SIP 010 trait
  ...
  ;; implement aibtc dao trait
  (impl-trait 'ST1Q9YZ2NY4KVBB08E005HAK3FSM8S3RX2WARP9Q1.aibtc-dao-traits.bitflow-pool)
  ...
  (define-constant CONTRACT_DEPLOYER 'ST2HH7PR5SENEXCGDHSHGS5RFPMACEDRN5EWQWKRW.lemar1-faktory-dex)
